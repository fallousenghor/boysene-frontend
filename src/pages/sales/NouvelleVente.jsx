...
export default function NouvelleVente({ onClose }) {
  ...
  return (
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent size="lg" className="max-w-5xl p-0">
          ...
          <div className="grid grid-cols-2 gap-5">
            ...
            <section className="rounded-xl border border-gray-200 shadow-sm p-4">
              ...
              <div className="mt-4 h-[520px] overflow-y-auto pr-1">
                {filteredProducts.length === 0 ? (
                  <div className="flex flex-col items-center justify-center h-48 text-sm text-gray-500 gap-2">
            ...
            <section className="rounded-xl border border-gray-200 shadow-sm p-4">
              ...
              <div className="rounded-lg border border-gray-200 bg-white p-3">
                ...
                {cart.length === 0 ? (
                  <div className="flex flex-col items-center justify-center h-56 text-gray-500 text-sm gap-3">
