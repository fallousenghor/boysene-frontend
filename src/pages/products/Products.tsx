      ...
      <Card>
        <div className="flex items-center gap-3 px-5 py-3 border-b border-border">
          ...
          <input
            ...
            onChange={async (e) => {
              ...
              try {
                ...
                const cats: any[] = (catsRes as any).data?.data || (catsRes as any).data || []
                const brands: any[] = (brandsRes as any).data?.data || (brandsRes as any).data || []
          ...
          <Button variant="ghost" size="sm" onClick={() => document.getElementById('import-json')?.click()}>
            <Package className="h-3.5 w-3.5" /> Importer JSON
          </Button>
        </div>
